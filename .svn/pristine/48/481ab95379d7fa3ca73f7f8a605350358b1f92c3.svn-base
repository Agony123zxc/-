...
var TableInit = function() {
    ...
    oTableInit.Init = function() {
        $('#tb_departments').bootstrapTable({
            url: port + '/v1/assetAcceptance/findAssetAcceptanceByLead',
            method: 'get',
            locale: 'zh-CN',
    ...
    oTableInit.queryParams = function(params) {
        var temp = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
            ...
            applyPersonNumber: $('#applyJobNum').val(), //申请人工号
    ...
    'click .info': function(e, value, row, index) {
        ...
        layer.open({
            ...
            success: function(layero, index) {
                ...
                body.find('#applyNum').attr('value', row.intodepotApplyPersonNumber); //人员工号
                body.find('#applyDate').attr('value', row.intodepotYuliu3); //申请时间
                ...
                // 下载附件
                if (row.intodepotFujian) {
                    body.find('#downloadFile').attr('href',row.intodepotFujian);
                }
            ...
            yes: function(index, layero) {
                ...
                layer.open({
                    ...
                    yes: function(index, layero) {
                        // 通过
                        $.ajax({
                            url: port + '/v1/assetAcceptance/singleAssetAcceptanceByLeader',
                            type: 'post',
                            data: {
