...
var TableInit = function() {
    ...
    oTableInit.Init = function() {
        $('#tb_departments').bootstrapTable({
            url: port + '/v1/assetAcceptance/findAssetAcceptanceByDepartment',
            method: 'get',
            locale: 'zh-CN',
            ...
            yes: function(index, layero) {
                ...
                layer.open({
                    ...
                    yes: function(index, layero) {
                        ...
                        // 通过
                        $.ajax({
                            url: port + '/v1/assetAcceptance/singleAssetAcceptanceByDepartment',
                            type: 'post',
                            data: {
        ...
        $("#one_key_check").on('click', function() {
            ...
            if (a.length == 0) {
                ...
                layer.open({
                    ...
                    yes: function(index, layero) {
                        $.ajax({
                            url: port + '/v1/applybuyAsset/auditingOnceLader',
                            type: 'post',
                            data: {
